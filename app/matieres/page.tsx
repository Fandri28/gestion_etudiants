        ...
        <table className="min-w-full border  border-gray-300 rounded-lg overflow-hidden">
          ...
          <tbody>
            {filteredMatieres.map((m) => (
              <tr key={m.id} className="text-center border-b hover:bg-gray-500">
                ...
                <td className="p-2  flex justify-center gap-2">
                  ...
                  <button
                    ...
                    className="bg-yellow-500 p-2 hover:bg-yellow-600 text-white  py-1 rounded flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-red-500 p-2 hover:bg-red-600 text-white px-2 py-1 rounded flex items-center gap-1"
                  >
